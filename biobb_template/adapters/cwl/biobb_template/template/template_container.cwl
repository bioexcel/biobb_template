...
label: Short description for the template container module in Restructured Text (reST)
  syntax. Mandatory.

doc: |-
  Long description for the template container module in Restructured Text (reST) syntax. Optional.

baseCommand: template_container
...
inputs:
  ...
  config:
    label: Advanced configuration options for biobb_template TemplateContainer
    doc: |-
      Advanced configuration options for biobb_template TemplateContainer. This should be passed as a string containing a dict. The possible options to include here are listed under 'properties' in the biobb_template TemplateContainer documentation: https://biobb-template.readthedocs.io/en/latest/template.html#module-template.template_container
    type: string?
    inputBinding:
      prefix: --config
